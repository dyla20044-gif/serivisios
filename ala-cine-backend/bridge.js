...
module.exports = function(app) {
    ...
    app.get('/view/:type/:id', async (req, res) => {
        ...
        // 1. Quitamos &type (Tu app no lo esperaba)
        // 2. Usamos Intent Scheme para forzar la apertura correcta en Android
        const appScheme = `intent://details?id=${id}#Intent;scheme=salacine;package=com.salacine.app;S.browser_fallback_url=${encodeURIComponent(PLAY_STORE_URL)};end`;
        // ==============================
        ...
        <body>
            <div class="hero">
                ...
                <div class="content">
                    ...
                    <div class="actions">
                        <a href="#" onclick="openApp()" class="btn btn-primary">▶ VER EN APP GRATIS</a>
            ...
            <div class="footer">Sala Cine © 2026<br><a href="${PLAY_STORE_URL}" style="color:#777;">Descargar App</a></div>
            <script>
                function openApp() {
                    // Usamos la URL Intent construida en el backend
